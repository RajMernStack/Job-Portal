      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className='text-2xl font-bold'>Job<span className='text-[#6A38C2]'>Portal</span></h2>
            <p className="text-sm text-gray-500 mt-1">© 2026 Your Company. All rights reserved.
              Built by Raj Soni
            </p>
          </div>
